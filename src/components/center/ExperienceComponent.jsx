...
import { getExperiencesAction, getExperiencesCSV, getMyProfileDetailsAction } from "../../redux/actions"
...
const ExperienceComponent = ({ profileData }) => {
  ...
  const downloadExperiences = () => {
    console.log("downloading experiences")
    dispatch(getExperiencesCSV(currentUserId))
  }
  // useEffect(() => {
          ...
          <Row className="my-2">
            <div className="col experience-container-design p-4 normal-cursor-on-hover">
              <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                  <div onClick={downloadExperiences}>Download Experiences</div>
