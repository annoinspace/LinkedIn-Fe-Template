    ...
    <Row className="my-2">
      <div className="col education-container-design p-4 normal-cursor-on-hover">
        <div className="d-flex justify-content-between">
          <h5 className="text-left mb-0 normal-cursor-on-hover font-weight-bold">Education</h5>
          <div className={pathname === "/me" ? "d-flex cursor-on-hover" : "d-none"}>
          ...
          {/* <ListGroup variant="flush" className="px-0 text-left">
            {user.education?.length !== 0
              ? user?.education.map((education) => {
                  return <SingleEducation key={education._id} edu={education} />
                })
              : "No experience yet"}
          </ListGroup> */}
        </div>
