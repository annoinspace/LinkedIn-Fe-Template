      ...
      <div style={{ color: "#5E5E5E" }}>
        <Container className="mt-4">
          <div className="d-flex ">
            <div className="bg-light mr-4 border" style={{ borderRadius: "10px", width: "30%", height: "100%" }}>
              <div className=" mb-2">
              ...
              <div className="text-center mt-3 mb-5">
                ...
                <p>
                  We’ll periodically import and store your contacts to help you and others connect. You choose who to
                  connect to and who to invite.
                </p>
                <div className="pr-2 pl-2">
                  <Form.Control type="email" placeholder="Enter username" className="" />
                  <Button variant="outline-primary" className="pt-1 pb-1 mt-2" style={{ borderRadius: "25px" }}>
                    Continue
                  </Button>
                </div>
              </div>
